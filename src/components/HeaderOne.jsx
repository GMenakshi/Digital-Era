        ...
        <div className="container container-full">
          <nav className="header-inner flx-between">
            ...
            <div className="logo">
              ...
              >
                <Image
                  src="/assets/images/logo44.png"
                  alt="Digital Era Logo"
                  width={40}
                  height={40}
              ...
              <ul className="nav-menu flx-align">
                ...
                <li className="nav-menu__item has-submenu">
                  ...
                  <ul className="nav-submenu">
                    <li
                      className={`nav-submenu__item ${
                        pathname == "/all-product" && "activePage"
                      }`}
                    >
                      <Link
                        scroll={false}
                ...
                <li className="nav-menu__item has-submenu">
                  ...
                  <ul className="nav-submenu">
                    ...
                    <li
                      className={`nav-submenu__item ${
                        pathname == "/cart-personal" && "activePage"
                      }`}
                    >
                      <Link
                        scroll={false}
                    ...
                    <li
                      className={`nav-submenu__item ${
                        pathname == "/cart-payment" && "activePage"
                      }`}
                    >
                      <Link
                        scroll={false}
                    ...
                    <li
                      className={`nav-submenu__item ${
                        pathname == "/cart-thank-you" && "activePage"
                      }`}
                    >
                      <Link
                        scroll={false}
                ...
                <li className="nav-menu__item has-submenu">
                  ...
                  <ul className="nav-submenu">
                    ...
                    <li
                      className={`nav-submenu__item ${
                        pathname == "/blog-details-sidebar" && "activePage"
                      }`}
                    >
                      <Link
                        scroll={false}
