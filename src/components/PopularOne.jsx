          ...
          <Slider {...settings}>
            ...
            <div>
              ...
              >
                ...
                <h6 className="popular-item__title font-18">Editing courses</h6>
                {/* <span className="popular-item__qty text-body">15,296</span> */}
              </Link>
            </div>
            <div>
              ...
              >
                ...
                <h6 className="popular-item__title font-18">Tech Plugins</h6>
                {/* <span className="popular-item__qty text-body">15,296</span> */}
              </Link>
            </div>
            <div>
              ...
              >
                ...
                <h6 className="popular-item__title font-18">Tech Templates</h6>
                {/* <span className="popular-item__qty text-body">15,296</span> */}
              </Link>
            </div>
            <div>
              ...
              >
                ...
                <h6 className="popular-item__title font-18">Coding Courses</h6>
                {/* <span className="popular-item__qty text-body">15,296</span> */}
              </Link>
            </div>
            {/* <div>
