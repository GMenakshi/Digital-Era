                  ...
                  <div className="profile-content__item-wrapper">
                    <div className="profile-content__item">
                      ...
                      <p className="profile-content__desc">
                        At Digital Era, our journey began in 2018 with a
                        singular mission: to craft innovative digital products
                        that empower businesses in the ever-evolving landscape
                        of the digital world. With a passion for technology and
                        a commitment to excellence, we have steadily grown into
                        a trusted name in the realm of digital solutions.
                      </p>
                    </div>
                    <div className="profile-content__item">
                    ...
                    <div className="row gy-4">
                      <div className="col-12">
                        ...
                        <input
                          ...
                          id="emailsId"
                          placeholder="Digital Era@gmail.com"
                        />
                      </div>
                      <div className="col-12">
                        <label
                  ...
                  <ul className="country-list">
                    <li className="country-list__item flx-between gap-2">
                      <div className="country-list__content flx-align gap-2">
                        ...
                        <span className="country-list__name">
                          United States
                        </span>
                      </div>
